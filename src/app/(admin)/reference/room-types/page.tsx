...
export default function RoomTypesPage() {
  return (
    <ReferenceDataPage
      ...
      fields={[
        { key: 'code', label: 'Code', type: 'text', required: true, placeholder: 'e.g., BED' },
        { key: 'name', label: 'Name', type: 'text', required: true, placeholder: 'Room type name' },
        { key: 'nameAr', label: 'Name (Arabic)', type: 'text', placeholder: 'نوع الغرفة' },
