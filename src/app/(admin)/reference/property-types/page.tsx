...
export default function PropertyTypesPage() {
  return (
    <ReferenceDataPage
      ...
      fields={[
        { key: 'code', label: 'Code', type: 'text', required: true, placeholder: 'e.g., VILLA' },
        { key: 'name', label: 'Name', type: 'text', required: true, placeholder: 'Property type name' },
        { key: 'nameAr', label: 'Name (Arabic)', type: 'text', placeholder: 'نوع العقار' },
