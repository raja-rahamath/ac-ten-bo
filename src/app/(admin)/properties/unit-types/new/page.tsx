...
export default function NewUnitTypePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const response = await fetch('http://localhost:4001/api/v1/unit-types', {
        method: 'POST',
        headers: {
      ...
      if (data.success) {
        ...
        setError(data.message || 'Failed to create unit type');
      }
    } catch (error) {
      console.error('Failed to create unit type:', error);
      setError('Failed to create unit type');
    } finally {
      setIsLoading(false);
    }
  }
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <div className="mb-6 flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-dark-800 dark:text-white">Add Unit Type</h1>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., 1 Bedroom, 2 Bedroom, Studio, Penthouse"
